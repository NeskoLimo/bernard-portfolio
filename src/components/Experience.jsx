...
const experiences = [
  {
    ...
    current: true,
    achievements: [
      'Engaged as an independent Business Analyst / Delivery Coordinator supporting Salesforce consulting, implementation, and digital transformation delivery for client engagements coordinated through the PMO.',
  ...
  },
  {
    ...
    current: false,
    achievements: [
      'Acted as Service Delivery Manager, leading a team of 7 across technical and operations functions while providing group-level support across 11 countries of operation.',
      'Led end-to-end requirements gathering with stakeholders, translating complex health insurance business needs into functional specifications and user stories, driving a 20% improvement in implementation efficiency.',
      'Served as primary liaison between business and technical teams for SmartInsure and Medismart platforms, ensuring alignment across multi-disciplinary teams.',
      'Standardised UAT processes for SmartInsure, achieving 98% compliance with functional and non-functional requirements and reducing post-launch defects by 20%.',
      'Tracked EDI performance, system downtime, bugs, and UAT findings, contributing to 99.99% system uptime across critical health insurance operations.',
      'Documented SOPs aligned with QMS guidelines, contributing to ISO 9001 certification in 2025, and developed the departmental Enterprise Risk Management (ERM) risk register as Acting Service Delivery Manager.',
      'Championed ESG initiatives as departmental ESG Champion, and mentored junior analysts, improving team delivery capacity by 15%.',
    ],
    tags: ['Service Delivery', 'Team Leadership', 'UAT', 'Requirements Elicitation', 'ISO 9001', 'ERM'],
  },
  {
    id: 3,
    ...
    current: false,
    achievements: [
      'Supported multi-payer health system integrations and platform rollouts, achieving 95% on-time delivery through effective stakeholder coordination.',
      'Monitored health system availability using Grafana and Prometheus, maintaining 99.9% uptime for critical operations.',
      'Designed and executed UAT protocols using Selenium and Postman, achieving 100% compliance with quality standards prior to each release.',
      'Conducted system and data analysis to identify workflow inefficiencies, recommending enhancements that improved automation by 10%.',
      'Delivered training to 50+ internal and external health system users, boosting adoption rates by 85%.',
      'Contributed to internal audits and quality assurance aligned with ISO 9001 and ISO/IEC 27001 standards.',
    ],
    tags: ['System Monitoring', 'UAT', 'Grafana', 'Prometheus', 'ISO 27001'],
  },
  {
    id: 4,
